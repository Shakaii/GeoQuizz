...
public class BackofficeApplicationTests {
	...
	public void getOneSerie() {
		...
		ResponseEntity<String> response = restTemplate.getForEntity("/series/"+s1.getId(), String.class);
    ...
    public void getAllSeries() {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity("/series", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).contains("Nancy");
	...
	public void notFoundAPI() throws Exception {
		ResponseEntity<String> response = restTemplate.getForEntity("/series/qsdfghjkllnbvcx", String.class);
	...
	public void postSerie() throws Exception {
		Serie c1 = new Serie("Nancy",3, "");
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		HttpEntity<String> entite = new HttpEntity<>(this.toJsonString(c1),headers);
		
		ResponseEntity<Serie> response = restTemplate.postForEntity("/series", entite, Serie.class);
